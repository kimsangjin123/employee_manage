			...
			<td>
				...
				<tbody class="boardWriteTbody" id="boardWriteTbody">
					...
					<tr>
						...
						<td valign="top">
						<input type="text" name="ssNumber1" maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="width:60px;"> -
						<input type="text" name="ssNumber2" maxlength="7" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="width:80px;" >
					...
					<tr>
						...
						<td>
						<input type="text" id="sample4_postcode" name="employeeAddr1" placeholder="우편번호" readonly>
						<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기">
						<input type="text" id="sample4_roadAddress" name="employeeAddr2" placeholder="도로명주소" readonly style="width:400px;"> <br>
					
						<input type="text" id="sample4_jibunAddress" name="employeeAddr3" placeholder="지번주소" readonly style="width:400px;"> <br>
						<span id="guide" style="color:#999;display:none"></span>
						<input type="text" id="sample4_detailAddress"  name="employeeAddr4" placeholder="상세주소" style="width:400px;"> <br>
						<input type="text" id="sample4_extraAddress"  name="employeeAddr5" placeholder="참고항목">
						</td>
